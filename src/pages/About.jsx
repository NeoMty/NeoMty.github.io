  ...
  return (
    <section className='max-container'>
      ...
      <div className='py-16'>
        ...
        <div className='mt-5 flex flex-col gap-3 text-slate-500'>
          <p>I've worked with all sorts of teams at my university and in 
            different companies, leveling up my skills and meeting awesome 
            people. Here's the rundown: </p>
        </div>
